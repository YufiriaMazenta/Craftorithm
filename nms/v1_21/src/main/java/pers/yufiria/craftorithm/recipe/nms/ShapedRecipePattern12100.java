...
public final class ShapedRecipePattern12100 extends CustomShapedRecipePattern<CraftingInput> {

    public ShapedRecipePattern12100(int width, int height, List<Optional<RecipeChoice>> ingredients) {
        super(width, height, ingredients);
    }

    public static ShapedRecipePattern12100 fromBukkitRecipe(ShapedRecipe shapedRecipe) {
        ...
        return new ShapedRecipePattern12100(width, height, ingredients);
    }
    ...
    public boolean matches(CraftingInput craftingInput, boolean symmetrical) {
        for (int i = 0; i < this.height; ++i) {
            for (int j = 0; j < this.width; ++j) {
                ...
                if (!IngredientUtils.testOptionalChoice(ingredient, bukkitInputItem)) {
                    return false;
                }
            }
        }
