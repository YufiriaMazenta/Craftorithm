...
public class CampfireCookingRecipe260300 extends CampfireCookingRecipe {

    private final RecipeChoice ingredient;
    private volatile Recipe cachedBukkitRecipe;

    CampfireCookingRecipe260300(net.minecraft.world.item.crafting.Recipe.CommonInfo commonInfo, AbstractCookingRecipe.CookingBookInfo bookInfo, Ingredient nmsIngredient, RecipeChoice ingredient, ItemStackTemplate result, float exp, int smeltTick) {
    ...
    public static RecipeHolder<CampfireCookingRecipe> fromBukkit(NamespacedKey recipeKey, org.bukkit.inventory.CampfireRecipe bukkitRecipe) {
        ...
        return new RecipeHolder<>(
            ...
            new CampfireCookingRecipe260300(
                commonInfo,
                bookInfo,
