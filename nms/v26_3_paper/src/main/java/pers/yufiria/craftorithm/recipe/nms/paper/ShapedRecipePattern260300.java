...
public final class ShapedRecipePattern260300 extends CustomShapedRecipePattern<CraftingInput> {

    public ShapedRecipePattern260300(int width, int height, List<Optional<RecipeChoice>> ingredients) {
        super(width, height, ingredients);
    }

    public static ShapedRecipePattern260300 fromBukkitRecipe(ShapedRecipe shapedRecipe) {
        ...
        return new ShapedRecipePattern260300(width, height, ingredients);
    }
    ...
    public boolean matches(CraftingInput craftingInput, boolean symmetrical) {
        for (int i = 0; i < this.height; ++i) {
            for (int j = 0; j < this.width; ++j) {
                ...
                org.bukkit.inventory.ItemStack bukkitInputItem = CraftItemStack.asBukkitMirror(nmsInputItem);
