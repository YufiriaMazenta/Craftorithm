...
public final class ShapedRecipe260300 extends ShapedRecipe {

    private final ShapedRecipePattern260300 customPattern;
    ...
    ShapedRecipe260300(
        ...
        ShapedRecipePattern260300 customPattern
    ) {
    ...
    public static RecipeHolder<ShapedRecipe> fromBukkit(NamespacedKey recipeKey, org.bukkit.inventory.ShapedRecipe shapedRecipe) {
        ...
        ShapedRecipePattern260300 customPattern = ShapedRecipePattern260300.fromBukkitRecipe(shapedRecipe);
        ...
        ShapedRecipe nmsRecipe = new ShapedRecipe260300(commonInfo, bookInfo, pattern, resultTemplate, customPattern);
