...
public class SmokingRecipe260300 extends SmokingRecipe {

    private final RecipeChoice ingredient;
    private volatile Recipe cachedBukkitRecipe;

    SmokingRecipe260300(net.minecraft.world.item.crafting.Recipe.CommonInfo commonInfo, AbstractCookingRecipe.CookingBookInfo bookInfo, Ingredient nmsIngredient, RecipeChoice ingredient, ItemStackTemplate result, float exp, int smeltTick) {
