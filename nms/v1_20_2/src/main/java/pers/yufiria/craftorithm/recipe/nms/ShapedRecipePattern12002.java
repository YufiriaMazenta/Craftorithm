...
public final class ShapedRecipePattern12002 extends CustomShapedRecipePattern<InventoryCrafting> {

    ShapedRecipePattern12002(
        int width,
        int height,
    ...
    public static ShapedRecipePattern12002 fromBukkitRecipe(ShapedRecipe shapedRecipe) {
        ...
        return new ShapedRecipePattern12002(width, height, ingredients);
    }
