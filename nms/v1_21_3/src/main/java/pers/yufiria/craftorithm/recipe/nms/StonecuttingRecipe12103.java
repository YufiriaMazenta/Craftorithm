...
public class StonecuttingRecipe12103 extends RecipeStonecutting {

    private final RecipeChoice ingredient;

    StonecuttingRecipe12103(String group, RecipeItemStack nmsIngredient, RecipeChoice ingredient, ItemStack result) {
