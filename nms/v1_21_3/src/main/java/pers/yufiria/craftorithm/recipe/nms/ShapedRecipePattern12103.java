...
public final class ShapedRecipePattern12103 extends CustomShapedRecipePattern<CraftingInput> {

    public ShapedRecipePattern12103(int width, int height, List<Optional<RecipeChoice>> ingredients) {
        super(width, height, ingredients);
    }

    public static ShapedRecipePattern12103 fromBukkitRecipe(ShapedRecipe shapedRecipe) {
        ...
        return new ShapedRecipePattern12103(width, height, ingredients);
    }
