...
public final class ShapedRecipe12103 extends ShapedRecipes {

    private final ShapedRecipePattern12103 customPattern;
    private final ItemStack result;

    ShapedRecipe12103(String group, CraftingBookCategory category, ShapedRecipePattern pattern, ItemStack result, ShapedRecipePattern12103 customPattern) {
    ...
    public static RecipeHolder<ShapedRecipes> fromBukkit(NamespacedKey recipeKey, ShapedRecipe shapedRecipe) {
        ...
        ShapedRecipePattern12103 customPattern = ShapedRecipePattern12103.fromBukkitRecipe(shapedRecipe);
        ShapedRecipes nmsShapedRecipe = new ShapedRecipe12103(craftRecipe.getGroup(), CraftRecipe.getCategory(craftRecipe.getCategory()), pattern, CraftItemStack.asNMSCopy(shapedRecipe.getResult()), customPattern);
