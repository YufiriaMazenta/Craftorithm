...
import org.bukkit.craftbukkit.v1_21_R2.inventory.CraftCampfireRecipe;
...
public class CampfireRecipe12103 extends RecipeCampfire {

    private final RecipeChoice ingredient;
    private volatile Recipe cachedBukkitRecipe;

    CampfireRecipe12103(String group, CookingBookCategory cookingbookcategory, RecipeItemStack recipeitemstack, RecipeChoice ingredient, ItemStack result, float exp, int smeltTick) {
