...
public final class ShapedRecipePattern12105 extends CustomShapedRecipePattern<CraftingInput> {

    public ShapedRecipePattern12105(int width, int height, List<Optional<RecipeChoice>> ingredients) {
        super(width, height, ingredients);
    }

    public static ShapedRecipePattern12105 fromBukkitRecipe(ShapedRecipe shapedRecipe) {
        ...
        return new ShapedRecipePattern12105(width, height, ingredients);
    }
