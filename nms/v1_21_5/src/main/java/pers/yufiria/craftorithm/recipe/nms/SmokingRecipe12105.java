...
public class SmokingRecipe12105 extends RecipeSmoking {

    private final RecipeChoice ingredient;
    private volatile Recipe cachedBukkitRecipe;

    SmokingRecipe12105(String group, CookingBookCategory cookingbookcategory, RecipeItemStack recipeitemstack, RecipeChoice ingredient, ItemStack result, float exp, int smeltTick) {
