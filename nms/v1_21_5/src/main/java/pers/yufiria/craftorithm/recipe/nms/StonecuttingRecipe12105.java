...
public class StonecuttingRecipe12105 extends RecipeStonecutting {

    private final RecipeChoice ingredient;

    StonecuttingRecipe12105(String group, RecipeItemStack nmsIngredient, RecipeChoice ingredient, ItemStack result) {
