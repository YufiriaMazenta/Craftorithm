...
public class SmithingTrimRecipe12005 extends SmithingTrimRecipe {
    ...
    public static RecipeHolder<SmithingTrimRecipe> fromBukkit(NamespacedKey recipeKey, org.bukkit.inventory.SmithingTrimRecipe bukkitRecipe) {
        ...
        return new RecipeHolder<>(CraftNamespacedKey.toMinecraft(recipeKey), new SmithingTrimRecipe12005(craftRecipe.toNMS(RecipeUtils.getBukkitChoice(bukkitRecipe.getTemplate()), true), bukkitRecipe.getTemplate(), craftRecipe.toNMS(RecipeUtils.getBukkitChoice(bukkitRecipe.getBase()), true), bukkitRecipe.getBase(), craftRecipe.toNMS(RecipeUtils.getBukkitChoice(bukkitRecipe.getAddition()), true), bukkitRecipe.getAddition()));
    }
}
