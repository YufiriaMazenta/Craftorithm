...
public final class ShapedRecipePattern12003 extends CustomShapedRecipePattern<InventoryCrafting> {

    ShapedRecipePattern12003(
        int width,
        int height,
    ...
    public static ShapedRecipePattern12003 fromBukkitRecipe(ShapedRecipe shapedRecipe) {
        ...
        return new ShapedRecipePattern12003(width, height, ingredients);
    }
