...
public class SmithingTransformRecipe12110 extends SmithingTransformRecipe {
    ...
    SmithingTransformRecipe12110(Optional<RecipeItemStack> nmsTemplate, Optional<RecipeChoice> template, RecipeItemStack nmsBase, RecipeChoice base, Optional<RecipeItemStack> nmsAddition, Optional<RecipeChoice> addition, TransmuteResult transmuteresult) {
