...
public class ShapelessRecipe12110 extends ShapelessRecipes {

    private final List<RecipeChoice> customIngredients;
    private final ItemStack result;
    private volatile Recipe cachedBukkitRecipe;

    ShapelessRecipe12110(String group, CraftingBookCategory category, ItemStack result, List<RecipeItemStack> nmsIngredients, List<RecipeChoice> customIngredients) {
    ...
    public static RecipeHolder<ShapelessRecipes> fromBukkit(NamespacedKey recipeKey, ShapelessRecipe shapelessRecipe) {
        ...
        ShapelessRecipes nmsRecipe = new ShapelessRecipe12110(craftRecipe.getGroup(), CraftRecipe.getCategory(craftRecipe.getCategory()), CraftItemStack.asNMSCopy(craftRecipe.getResult()), nmsIngredients, bukkitIngredients);
