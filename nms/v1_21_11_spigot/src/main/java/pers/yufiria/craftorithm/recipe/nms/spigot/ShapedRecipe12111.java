...
public final class ShapedRecipe12111 extends ShapedRecipes {

    private final ShapedRecipePattern12111 customPattern;
    private final ItemStack result;
    private volatile Recipe cachedBukkitRecipe;

    ShapedRecipe12111(String group, CraftingBookCategory category, ShapedRecipePattern pattern, ItemStack result, ShapedRecipePattern12111 customPattern) {
    ...
    public static RecipeHolder<ShapedRecipes> fromBukkit(NamespacedKey recipeKey, ShapedRecipe shapedRecipe) {
        ...
        ShapedRecipePattern12111 customPattern = ShapedRecipePattern12111.fromBukkitRecipe(shapedRecipe);
        ShapedRecipes nmsShapedRecipe = new ShapedRecipe12111(craftRecipe.getGroup(), CraftRecipe.getCategory(craftRecipe.getCategory()), pattern, CraftItemStack.asNMSCopy(shapedRecipe.getResult()), customPattern);
