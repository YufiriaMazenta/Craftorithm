...
public enum CraftorithmRecipeRegister12111 implements CraftorithmRecipeRegister, LifeCycleTask {
    ...
    public void lifecycle(Object plugin, LifeCycle lifeCycle) {
        if (!CrypticLibBukkit.isPaper()) {
            REGISTER_COMPAT.register(MinecraftVersion.V1_21_11.name(), () -> this);
        }
    }
}
