...
public class StonecuttingRecipe12111 extends RecipeStonecutting {

    private final RecipeChoice ingredient;

    StonecuttingRecipe12111(String group, RecipeItemStack nmsIngredient, RecipeChoice ingredient, ItemStack result) {
