...
public final class ShapedRecipePattern12111 extends CustomShapedRecipePattern<CraftingInput> {

    public ShapedRecipePattern12111(int width, int height, List<Optional<RecipeChoice>> ingredients) {
        super(width, height, ingredients);
    }

    public static ShapedRecipePattern12111 fromBukkitRecipe(ShapedRecipe shapedRecipe) {
        ...
        return new ShapedRecipePattern12111(width, height, ingredients);
    }
