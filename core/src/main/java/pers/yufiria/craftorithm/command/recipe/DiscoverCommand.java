...
public class DiscoverCommand extends CommandNode {
    ...
    public static final DiscoverCommand INSTANCE = new DiscoverCommand();

    private DiscoverCommand() {
        super(CommandInfo
            .builder("discover")
            .permission(new PermInfo("craftorithm.command.discover"))
            .usage("&r/craftorithm discover <target> <recipe_key_pattern>")
            .build()
        );
    }
