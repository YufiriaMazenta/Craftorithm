...
@ConfigHandler(path = "menus/internal/editor/vanilla_shaped.yml")
public class VanillaShapedEditorConfig {

    public static final StringConfig TITLE = new StringConfig("title", "<translate:lang:recipe_type_name.vanilla_shaped> - <recipe_key> - <translate:lang:menu.editor.name>");
