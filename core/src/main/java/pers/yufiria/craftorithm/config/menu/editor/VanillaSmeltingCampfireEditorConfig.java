...
public class VanillaSmeltingCampfireEditorConfig {
    public static final StringConfig TITLE = new StringConfig("title", "<translate:lang:recipe_type_name.vanilla_smelting_campfire> - <recipe_key> - <translate:lang:menu.editor.name>");
