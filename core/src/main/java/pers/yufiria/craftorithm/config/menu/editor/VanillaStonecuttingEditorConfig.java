...
public class VanillaStonecuttingEditorConfig {
    public static final StringConfig TITLE = new StringConfig("title", "<translate:lang:recipe_type_name.vanilla_stonecutting> - <recipe_key> - <translate:lang:menu.editor.name>");
