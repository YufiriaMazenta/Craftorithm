...
@ConfigHandler(path = "menus/internal/editor/vanilla_smelting_blast.yml")
public class VanillaSmeltingBlastEditorConfig {
    public static final StringConfig TITLE = new StringConfig("title", "<translate:lang:recipe_type_name.vanilla_smelting_blast> - <recipe_key> - <translate:lang:menu.editor.name>");
