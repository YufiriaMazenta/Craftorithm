...
@ConfigHandler(path = "menus/internal/creator/vanilla_smelting_smoker.yml")
public class VanillaSmeltingSmokerCreatorConfig {

    public static final StringConfig TITLE = new StringConfig("title", "<translate:lang:recipe_type_name.vanilla_smelting_smoker><translate:lang:menu.recipe_creator.name>");
