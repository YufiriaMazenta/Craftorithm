...
@ConfigHandler(path = "menus/internal/creator/vanilla_smelting_furnace.yml")
public class VanillaSmeltingFurnaceCreatorConfig {

    public static final StringConfig TITLE = new StringConfig("title", "<translate:lang:recipe_type_name.vanilla_smelting_furnace><translate:lang:menu.recipe_creator.name>");
    ...
    public static final IntConfig DEFAULT_TIME = new IntConfig("default_time", 200);
