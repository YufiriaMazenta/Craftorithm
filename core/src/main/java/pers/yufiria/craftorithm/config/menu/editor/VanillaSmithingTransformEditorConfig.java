...
public class VanillaSmithingTransformEditorConfig {
    public static final StringConfig TITLE = new StringConfig("title", "<translate:lang:recipe_type_name.vanilla_smithing_transform> - <recipe_key> - <translate:lang:menu.editor.name>");
