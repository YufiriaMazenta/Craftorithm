...
public class VanillaSmeltingFurnaceEditorConfig {
    public static final StringConfig TITLE = new StringConfig("title", "<translate:lang:recipe_type_name.vanilla_smelting_furnace> - <recipe_key> - <translate:lang:menu.editor.name>");
