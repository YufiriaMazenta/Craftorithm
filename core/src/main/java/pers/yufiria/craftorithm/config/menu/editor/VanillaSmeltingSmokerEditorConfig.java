...
@ConfigHandler(path = "menus/internal/editor/vanilla_smelting_smoker.yml")
public class VanillaSmeltingSmokerEditorConfig {
    public static final StringConfig TITLE = new StringConfig("title", "<translate:lang:recipe_type_name.vanilla_smelting_smoker> - <recipe_key> - <translate:lang:menu.editor.name>");
