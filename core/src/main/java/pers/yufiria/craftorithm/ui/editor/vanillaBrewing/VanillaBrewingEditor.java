...
public final class VanillaBrewingEditor extends RecipeEditorMenu {
    ...
    private Icon getFrameIcon() {
        return CreatorIconParser.INSTANCE.parse(VanillaBrewingEditorConfig.FRAME_ICON.value()).get();
    }
    ...
    private Icon getConfirmIcon() {
        IconDisplay iconDisplay = CreatorIconParser.INSTANCE.parseIconDisplay(VanillaBrewingEditorConfig.CONFIRM_ICON.value());
