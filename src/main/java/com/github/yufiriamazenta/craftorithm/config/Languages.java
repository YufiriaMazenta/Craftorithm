...
public class Languages {
    ...
    public static final StringLangConfigEntry MENU_RECIPE_GROUP_LIST_TITLE = new StringLangConfigEntry("menu.recipe_group_list.title");
    public static final StringLangConfigEntry MENU_RECIPE_GROUP_LIST_ICON_FRAME = new StringLangConfigEntry("menu.recipe_group_list.icon.frame");
    public static final StringLangConfigEntry MENU_RECIPE_GROUP_LIST_ICON_PREVIOUS = new StringLangConfigEntry("menu.recipe_group_list.icon.previous");
    public static final StringLangConfigEntry MENU_RECIPE_GROUP_LIST_ICON_NEXT = new StringLangConfigEntry("menu.recipe_group_list.icon.next");
    public static final StringListLangConfigEntry MENU_RECIPE_GROUP_LIST_ICON_ELEMENTS_LORE = new StringListLangConfigEntry("menu.recipe_group_list.icon.elements.lore");
