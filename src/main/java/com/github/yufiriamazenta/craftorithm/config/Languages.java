...
public class Languages {
    ...
    public static final StringLangEntry MENU_RECIPE_GROUP_LIST_TITLE = new StringLangEntry("menu.recipe_group_list.title");
    public static final StringLangEntry MENU_RECIPE_GROUP_LIST_ICON_FRAME = new StringLangEntry("menu.recipe_group_list.icon.frame");
    public static final StringLangEntry MENU_RECIPE_GROUP_LIST_ICON_PREVIOUS = new StringLangEntry("menu.recipe_group_list.icon.previous");
    public static final StringLangEntry MENU_RECIPE_GROUP_LIST_ICON_NEXT = new StringLangEntry("menu.recipe_group_list.icon.next");
    public static final StringListLangEntry MENU_RECIPE_GROUP_LIST_ICON_ELEMENTS_LORE = new StringListLangEntry("menu.recipe_group_list.icon.elements.lore");
