...
public class ShapedRecipeCreator extends RecipeCreator {

    public ShapedRecipeCreator(@NotNull Player player, @NotNull String recipeName) {
        super(player, RecipeType.SHAPED, recipeName);
