...
import pers.yufiriamazenta.craftorithm.recipe.custom.AnvilRecipe;
import pers.yufiriamazenta.craftorithm.recipe.custom.CustomRecipe;
import pers.yufiriamazenta.craftorithm.recipe.custom.PotionMixRecipe;
...
import pers.yufiriamazenta.craftorithm.util.RecipeUtil;
...
public enum RecipeManager {
    ...
    RecipeManager() {
        ...
        //设置各类型配方的注册方法
        recipeRegisterMap.put(RecipeType.SHAPED, RecipeUtil::regVanillaRecipe);
        recipeRemoverMap.put(RecipeType.SHAPED, this::removeRecipes);
        recipeRegisterMap.put(RecipeType.SHAPELESS, RecipeUtil::regVanillaRecipe);
        recipeRemoverMap.put(RecipeType.SHAPELESS, this::removeRecipes);
        recipeRegisterMap.put(RecipeType.COOKING, RecipeUtil::regVanillaRecipe);
        recipeRemoverMap.put(RecipeType.COOKING, this::removeRecipes);
        recipeRegisterMap.put(RecipeType.STONE_CUTTING, RecipeUtil::regVanillaRecipe);
        recipeRemoverMap.put(RecipeType.STONE_CUTTING, this::removeRecipes);
        recipeRegisterMap.put(RecipeType.SMITHING, RecipeUtil::regVanillaRecipe);
        recipeRemoverMap.put(RecipeType.SMITHING, this::removeRecipes);
        recipeRegisterMap.put(RecipeType.RANDOM_COOKING, RecipeUtil::regVanillaRecipe);
